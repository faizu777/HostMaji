...
<!-- Mirrored from HostMaji.themetags.com/terms-condition.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:50 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Terms Condition - Hosting Provider with WHMCS Template</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            ...
                            <p class="lead">Compellingly maintain standardized processes without synergistic customer service. Energistically deliver top-line sources with web-enabled ROI.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="content-with-sidebar">
                            <div class="section-heading">
                                <h3>Welcome to HostMaji Terms & conditions</h3>
                                <p class="lead">Effective date: 1 January 2020</p>
                            </div>
                            <div id="nav-id-1" class="pt-5">
                                <p>These terms and conditions outline the rules and regulations for the use of HostMaji's Website.</p> <br />
                                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use HostMaji's website
                                ...
                                <h5>Cookies</h5>
                                <p>We employ the use of cookies. By using HostMaji's website you consent to the use of cookies
                                    in accordance with HostMaji's privacy policy.</p>
                                <p>Most of the modern day interactive web sites
                                    use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
                                    to enable the functionality of this area and ease of use for those people visiting. Some of our
                                    affiliate / advertising partners may also use cookies.</p>
                                <h5>License</h5>
                                <p>Unless otherwise stated, HostMaji and/or it's licensors own the intellectual property rights for
                                    all material on HostMaji. All intellectual property rights are reserved. You may view and/or print
                                    pages from http://HostMajitags.com for your own personal use subject to restrictions set in these terms and conditions.</p>
                                <p>You must not:</p>
                                <ol>
                                    <li>Republish material from http://HostMajitags.com</li>
                                    <li>Sell, rent or sub-license material from http://HostMajitags.com</li>
                                    <li>Reproduce, duplicate or copy material from http://HostMajitags.com</li>
                                </ol>
                                <p>Redistribute content from HostMaji (unless content is specifically made for redistribution).</p>
                            </div>
                            <div id="nav-id-2" class="pt-5">
                                ...
                                <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
                                    ...
                                    the visibility associated with the hyperlink outweighs the absence of HostMaji; and (d) where the
                                ...
                                <p>No use of HostMaji's logo or other artwork will be allowed for linking absent a trademark license
                                    agreement.</p>
                            </div>
                        ...
                        <div id="sticky">
                            <div class="sidebar-content-wrap p-5 rounded">
                                ...
                                <ul class="sidebar-list">
                                    <li><a href="#nav-id-1">Welcome HostMaji</a></li>
                                    <li><a href="#nav-id-2">Hyperlinking to our Content </a></li>
                                    <li><a href="#nav-id-3">Iframes</a></li>
                                    <li><a href="#nav-id-4">Reservation of Rights</a></li>
                                    <li><a href="#nav-id-5">Removal of links from our website</a></li>
                                    <li><a href="#nav-id-6">Content Liability</a></li>
                                    <li><a href="#nav-id-7">Disclaimer</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
