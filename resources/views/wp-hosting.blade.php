            ...
            <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                ...
                <div id="navBar" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto main-navbar-nav">
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item" data-position="left">
                            <a id="homeMegaMenu" class="nav-link custom-nav-link " href="#" >Free Hosting</a>
...
<!--header section end-->
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-100 gradient-bg" style="background: url('assets/img/hero-17.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="hero-content-wrap text-white position-relative z-index">
                            ...
                            <p class="mb-2 small">Starting at <strong>$2.59/mo</strong>*. Upgrade performance for a few dollars more </p>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="img-wrap">
                            <img src="assets/img/wordpress-hosting-white.svg" alt="wordpress hosting" class="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>If you’re not 100% satisfied with HostMaji, we’ll refund your payment no risk</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
