...
<!-- Mirrored from HostMaji.themetags.com/wp-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:54 GMT -->
...
<head>
    ...
    <!--title-->
    <title>Wp Hosting - Hosting Provider with WHMCS Template</title>
...
<body>
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-100 gradient-bg"
                ...
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="hero-content-wrap text-white position-relative z-index">
                            <h1 class="text-white">We Make WordPress Easier</h1>
                            <p class="lead">Sell anything, anywhere, anytime on the world's biggest eCommerce
                                platform. Up to 50% Off domain and hosting, Starting from ₹
                                60
                                /month.</p>
                            <ul class="hosting-feature-list two-col-list py-3">
                                <li><span class="ti-check mr-2"></span>Look like a Pro</li>
                                <li><span class="ti-check mr-2"></span>Secure & Always Up</li>
                                <li><span class="ti-check mr-2"></span>1-Click Install</li>
                                <li><span class="ti-check mr-2"></span>Zero-Risk</li>
                                <li><span class="ti-check mr-2"></span>Money-Back Guarantee</li>
                                <li><span class="ti-check mr-2"></span>Free SSL Certificate</li>
                                <li><span class="ti-check mr-2"></span>Unlimited Email</li>
                                <li><span class="ti-check mr-2"></span>24/7/365 Day Support </li>
                            </ul>
                            <p class="mb-2 small">Starting at <strong>₹
                                    60
                                    /mo</strong>*. Upgrade performance for a few dollars more </p>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="img-wrap">
                            <img src="assets/img/wordpress-hosting-white.svg" alt="wordpress hosting"
                                class="img-fluid" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading mb-5">
                            <h2>Why Choose Us?</h2>
                            <p class="lead">Completely expedite holistic e-markets without synergistic "outside the
                                box"
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card text-center single-pricing-pack">
                            ...
                            <div class="card-header pb-4 border-0 pricing-header">
                                <div class="price text-center mb-0">₹ 60
                                    <span>/month</span></div>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="feature-content-wrap">
                            <ul class="nav nav-tabs feature-tab feature-new-tab justify-content-center mb-5 border-bottom-0"
                                data-tabs="tabs">
                                <li class="nav-item">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>You can never go wrong with our own top-notch dedicated servers
                                                    loaded</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>We can guarantee an excellent experience and loading time for your
                                                    successful</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>With full root access you will be able to take full control of your
                                                    server very easy</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>One of many premium features is a dedicated IP cheapest VPS hosting
                                                    plan</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                <span
                                                    class="ti-location-pin icon-sm d-block color-primary mb-3"></span>
                                                <h5 class="mb-2">IPv6 Support</h5>
                                                <p>Our VPS hosting plan is fully packed with dedicated IPv6 Internet
                                                    protocol IP</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="feature-feature-list p-4 text-center">
                                                ...
                                                <p>If you’re not 100% satisfied with HostMaji, we’ll refund your payment
                                                    no risk</p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="client-review-section ptb-100 ">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
