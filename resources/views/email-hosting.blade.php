...
<!-- Mirrored from HostMaji.themetags.com/email-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:51 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Email Hosting - Hosting Provider with WHMCS Template</title>
...
<body>
 ...
 <!--menu title with subtitle and icon item end-->
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-100 gradient-overly-bottom" style="background: url('assets/img/hero-16.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="hero-content-wrap text-white position-relative z-index">
                            <h1 class="text-white">Managed Professional Email</h1>
                            <p class="lead">Promote your site with every message you send with an email address that matches your website. Professional email with Microsoft Office 365. </p>
                            <ul class="list-unstyled">
                                <li class="py-1">
                                    <div class="d-flex align-items-center">
                                        <span class="ti-check mr-2"></span>
                                        <p class="mb-0">Huge 25GB Storage per Mailbox</p>
                                    </div>
                                </li>
                                <li class="py-1">
                                    <div class="d-flex align-items-center">
                                        <span class="ti-check mr-2"></span>
                                        <p class="mb-0">Mobile and Desktop Sync</p>
                                    </div>
                                </li>
                                <li class="py-1">
                                    <div class="d-flex align-items-center">
                                        <span class="ti-check mr-2"></span>
                                        <p class="mb-0">Ad-Free Webmail Built In</p>
                                    </div>
                                </li>
                                <li class="py-1">
                                    <div class="d-flex align-items-center">
                                        <span class="ti-check mr-2"></span>
                                        <p class="mb-0">Spam, Virus, and Phishing Filters</p>
                                    </div>
                                </li>
                            </ul>
                            <div class="action-btns mt-5">
                                <a href="#" class="btn solid-white-btn mr-3">View Pricing</a>
                                <a href="#" class="btn outline-white-btn">Package Comparision</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        <div class="img-wrap">
                            <img src="assets/img/email-hosting-white.svg" alt="email hosting" class="img-fluid" />
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from HostMaji.themetags.com/email-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:53 GMT -->
</html>