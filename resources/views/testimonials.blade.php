...
<!-- Mirrored from hostlar.themetags.com/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Testimonials - Hosting Provider with WHMCS Template</title>
...
<body>
 ...
 <!--menu title with subtitle and icon item end-->
    ...
    <div class="main">
        ...
        <section class="page-header-section ptb-100 gradient-overly-right" style="background: url('assets/img/hero-16.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Testimonials</h1>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Testimonials</li>
                            </ol>
                        </div>
                    </div>
                </div>
