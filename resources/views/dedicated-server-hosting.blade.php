...
<!-- Mirrored from HostMaji.themetags.com/dedicated-server-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:51 GMT -->
...
<head>
    ...
    <!--title-->
    <title>Dedicated Hosting - Hosting Provider with WHMCS Template</title>
...
<body>
    ...
    <div class="main">
        <!--hero section start-->
        <section class="hero-equal-height pt-165 ptb-100 gradient-overly-bottom"
            style="background: url('assets/img/hero-1.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="hero-content-wrap text-white text-center position-relative z-index">
                            ...
                            <p class="lead">Progressively integrate cost effective methods of empowerment vis-a-vis
                                standardized information. Uniquely whiteboard functionalized.</p>
                ...
                <div class="row align-items-center justify-content-between">
                        ...
                        <div class="card text-center single-pricing-pack">
                            ...
                            <div class="card-header pb-4 border-0 pricing-header">
                                <div class="price text-center mb-0 monthly-price">
                                    ₹{{ $price = 3495; }}<span>/month</span></div>
                                <div class="price text-center mb-0 yearly-price">  ₹{{ $price = 3495*12; }}<span>/yearly</span></div>
                                <div class="price text-center mb-0 biannual-price"> ₹{{ $price*24; }}<span>/biannual</span></div>
                                <div class="price text-center mb-0 triennial-price">  ₹{{ $price*36; }}<span>/triennial</span>
                                </div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card popular-price text-center single-pricing-pack">
                            ...
                            <div class="card-header pb-4 border-0 pricing-header">
                                <div class="price text-center mb-0 monthly-price">₹ {{$price2=8792;}}<span>/month</span></div>
                                <div class="price text-center mb-0 yearly-price">₹ {{$price2*12;}}<span>/yearly</span></div>
                                <div class="price text-center mb-0 biannual-price">₹ {{$price2*24;}} <span>/biannual</span></div>
                                <div class="price text-center mb-0 triennial-price"> ₹ {{$price2*36;}}<span>/triennial</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled mb-4 pricing-feature-list">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card text-center single-pricing-pack">
                            ...
                            <div class="card-header pb-4 border-0 pricing-header">
                                <div class="price text-center mb-0 monthly-price">₹ {{$price3=11192;}}<span>/month</span></div>
                                <div class="price text-center mb-0 yearly-price">₹ {{$price3*12;}}<span>/yearly</span></div>
                                <div class="price text-center mb-0 biannual-price">₹ {{$price3*24;}} <span>/biannual</span></div>
                                <div class="price text-center mb-0 triennial-price"> ₹ {{$price3*36;}}<span>/triennial</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled mb-4 pricing-feature-list">
                    ...
                    <div class="col-md-6 col-lg-4 col-12">
                        <div class="technical-specifications-wrap mt-md-5 mt-lg-5">
                            ...
                            <ul class="list-unstyled tech-feature-list">
                                ...
                                <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span><strong>
                                        ₹ 8349</strong> Google Adwords Offer (Details)</li>
                                <li class="py-1"><span class="ti-control-forward mr-2 color-primary"></span><strong>
                                        ₹ 8349</strong> Bing Ads Credit (Details)</li>
                                <li class="py-1"><span
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="call-to-action-box white-bg shadow-sm rounded p-5">
                            ...
                            <p>Made possible by our multiple datacenter locations, redundant cooling, emergency
                                generators.
        ...
        <section class="compare-provider-table ptb-100 gray-light-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            <h2>HostMaji head to head comparison</h2>
                            <p class="lead">
                                ...
                                <thead class="comparision-table-head">
                                    <tr>
                                        ...
                                        <th class="primary-bg text-white provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/logo.color.png"
                                                class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-01.png"
                                                class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-02.png"
                                                class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-03.png"
                                                class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-04.png"
                                                class="img-fluid" />
                                        </th>
                                    </tr>
                                </thead>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="single-faq pt-4">
                            ...
                            <p>Assertively iterate user friendly innovation without open-source markets. Monotonectally
                                extend
                                resource sucking manufactured products without high-payoff paradigms. Objectively
                                customize
                    ...
                    <div class="col-md-6">
                        <div class="single-faq pt-4">
                            ...
                            <p>Dramatically target focused testing procedures after holistic ideas. Collaboratively
                                maximize
                                high-payoff ROI and value-added products. Distinctively deliver cooperative
                                collaboration and
                    ...
                    <div class="col-md-6">
                        <div class="single-faq pt-4">
                            ...
                            <p>Distinctively simplify high-quality initiatives for highly efficient applications.
                                Monotonectally
                    ...
                    <div class="col-md-6">
                        <div class="single-faq pt-4">
                            ...
                            <p>Assertively target turnkey ideas for market-driven portals. Appropriately e-enable
                                world-class
