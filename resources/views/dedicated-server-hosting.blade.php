                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card text-center single-pricing-pack">
                            ...
                            <div class="card-header pb-4 border-0 pricing-header">
                                ...
                                <div class="price text-center mb-0 biannual-price"> ₹ 10859<span>/biannual</span></div>
                                ...
                                <thead class="comparision-table-head">
                                    <tr>
                                        ...
                                        <th class="primary-bg text-white provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/logo-white.png" class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-01.png" class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-02.png" class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-03.png" class="img-fluid" />
                                        </th>
                                        <th class="provider-logo">
                                            <img alt="HostMaji-logo" src="assets/img/clients-logo-04.png" class="img-fluid" />
                                        </th>
                                    </tr>
                                </thead>
