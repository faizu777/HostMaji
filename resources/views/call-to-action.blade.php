...
<!-- Mirrored from HostMaji.themetags.com/call-to-action.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Call To Action - Hosting Provider with WHMCS Template</title>
                        ...
                        <div class="topbar-text d-none d-md-block d-lg-block">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="tell:+91 9795405324"><span class="fas fa-phone mr-2"></span> 24x7 Technical Support 888-1234567</a>
                                </li>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Call To Action</h1>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Call To Action</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="feature-content-wrap">
                ...
                <div class="tab-content feature-tab-content">
                    ...
                    <div class="tab-pane" id="feature-tab-2">
                        <!--call to action background image start-->
                                    ...
                                    <div class="col-md-9 col-lg-8">
                                        <div class="call-to-action-content text-white text-center">
                                            ...
                                            <div class="action-btns mt-3">
                                                <a href="#" class="btn outline-white-btn mr-3">Existing Customers</a>
                        ...
                        <!--call to action background image end-->
                    </div>
                    <div class="tab-pane" id="feature-tab-3">
                        <!--domain search cta start-->
                        <section class="domain-search-cta-type ptb-100 gray-light-bg">
                            <div class="container">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-md-7 col-lg-7">
                                        <div class="domain-search-content">
                                            <h2>Search Unique Domain Now!</h2>
                                            <p>Get your perfect domain name starting from <strong>9.99$ </strong> for the first year and
                                                free domain privacy included build efficient experiences rather than holistic.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="domain-search-wrap">
                                            <form action="#" class="domain-search-form">
                                                <div class="input-group">
                                                    <input type="email" class="form-control" id="email" placeholder="example.com" required="">
                                            ...
                                            <div class="domain-list-wrap mt-4 d-flex justify-content-center">
                                                <ul class="list-inline domain-search-list">
                                                    <li class="list-inline-item"><a href="#"><img src="assets/img/com.png" alt="com" width="45" class="img-fluid"> <span>$8.99</span></a>
                                                    </li>
                                                    <li class="list-inline-item"><a href="#"><img src="assets/img/online.png" alt="com" width="45" class="img-fluid"> <span>$0.99</span></a>
                                                    </li>
                                                    <li class="list-inline-item"><a href="#"><img src="assets/img/net.png" alt="com" width="45" class="img-fluid"> <span>$4.99</span></a>
                                                    </li>
                                                    <li class="list-inline-item"><a href="#"><img src="assets/img/org.png" alt="com" width="45" class="img-fluid"> <span>$2.99</span></a>
                                                    </li>
                                                    <li class="list-inline-item"><a href="#"><img src="assets/img/store.png" alt="com" width="45" class="img-fluid"> <span>$0.99</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane" id="feature-tab-5">
                        <!--call to action with image start-->
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="cta-new-wrap">
                                            ...
                                            <div class="action-btns mt-4">
                                                <a href="#" class="btn primary-solid-btn animated-btn mr-lg-3">Get
                                                    Started Now</a>
                                            </div>
                                        </div>
                                    </div>
