...
<!-- Mirrored from HostMaji.themetags.com/partners.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:13:00 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Partners - Hosting Provider with WHMCS Template</title>
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                            ...
                            <li class="nav-item hs-has-mega-menu custom-nav-item" data-position="left">
                                <a id="homeMegaMenu" class="nav-link custom-nav-link main-link-toggle" href="{{route('index')}}" aria-haspopup="false" aria-expanded="false">Home</a>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Our Partners</h1>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Partners</li>
                            </ol>
                        </div>
                    </div>
                </div>
