...
<!-- Mirrored from HostMaji.themetags.com/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:55 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Team - Hosting Provider with WHMCS Template</title>
...
<body>
 ...
 <!--menu title with subtitle and icon item end-->
    ...
    <div class="main">
        ...
        <section class="page-header-section ptb-100 gradient-overly-right" style="background: url('assets/img/hero-5.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Team</h1>
        ...
        <section class="our-team-section ptb-100 gray-light-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-8">
                        <div class="section-heading text-center mb-3">
                            <h2>Our Expert Team</h2>
                            <p class="lead">Grow go forward manufactured products and optimal networks. Enthusiastically
                                disseminate user-centric outsourcing through revolutionary</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="staff-member mt-md-4 mt-lg-4">
