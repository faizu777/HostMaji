...
<!-- Mirrored from HostMaji.themetags.com/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:51 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="main">
        ...
        <section class="gradient-overlay ptb-100 height-lg-100vh d-flex align-items-center" style="background: url('assets/img/hero-bg-4.jpg')no-repeat center center / cover">
            <div class="container">
                    ...
                    <div class="col-md-9 col-lg-7">
                        <div class="error-content text-center text-white">
                            ...
                            <p>The page you are looking for might have been removed had its name changed or is temporarily
                                unavailable.</p><a class="btn outline-white-btn" href="{{route('index')}}">Go to Homepage</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-5 col-lg-5">
                        <p class="copyright-text pb-0 mb-0 text-white">Copyrights © 2021. All
                            rights reserved by
                            <a href="#" target="_blank">ThemeTags</a>
                        </p>
                    </div>
