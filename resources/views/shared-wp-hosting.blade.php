...
<!-- Mirrored from HostMaji.themetags.com/shared-wp-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:53 GMT -->
<head>
    <meta charset="utf-8">
...
<!--header section end-->
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-100 gradient-overly-right" style="background: url('assets/img/hero-bg4.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-8">
                        <div class="hero-content-wrap text-white position-relative">
                            <h1 class="text-white">Shared WordPress Hosting</h1>
                            <p class="lead">Build and grow the perfect WordPress website with WooCommerce Pro.</p>
        ...
        <section class="promo-feature ptb-100 gradient-overlay" style="background: url('assets/img/hero-bg1.jpg')no-repeat center center / cover fixed">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-feature-list p-3 text-center text-white">
                            <span class="ti-thumb-up icon-md d-block mb-3"></span>
                            <h5 class="mb-2 text-white">100% Network Uptime</h5>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-feature-list p-3 text-center text-white">
                            ...
                            <h5 class="mb-2 text-white">24x7 Tech Support</h5>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-feature-list p-3 text-center text-white">
                            ...
                            <h5 class="mb-2 text-white">DDoS Protection</h5>
                            <p>Professionally envisioneer adaptive materials schemas</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-feature-list p-3 text-center text-white">
                            <span class="ti-user icon-md d-block mb-3"></span>
                            <h5 class="mb-2 text-white">Trusted by Millions</h5>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-9 col-12 order-xl-first">
                        ...
                        <div class="action-btns mt-4">
                            <a href="#" class="btn primary-solid-btn mr-3">Start Now</a>
...
<!-- Mirrored from HostMaji.themetags.com/shared-wp-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:54 GMT -->
</html>
