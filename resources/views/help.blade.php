...
<!-- Mirrored from HostMaji.themetags.com/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:50 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Help - Hosting Provider with WHMCS Template</title>
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                            ...
                            <li class="nav-item hs-has-mega-menu custom-nav-item" data-position="left">
                                <a id="homeMegaMenu" class="nav-link custom-nav-link main-link-toggle" href="javascript:void(0);" aria-haspopup="false" aria-expanded="false">Home</a>
    ...
    <div class="main">
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Help</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <section class="our-help-center ptb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            <h2>Welcome Our Customers Help Center</h2>
                            <p>Authoritatively conceptualize progressive paradigms rather than timely potentialities.
                                Rapidiously simplify out-of-the-box outsourcing rather.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-around pt-100">
                    <div class="col-md-7 col-lg-7">
...
<!-- Mirrored from hostlar.themetags.com/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:50 GMT -->
</html>