...
<!-- Mirrored from HostMaji.themetags.com/support.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:58 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Support - Hosting Provider with WHMCS Template</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            ...
                            <p class="lead">Continually strategize orthogonal core competencies for interdependent potentialities. Collaboratively pursue end-to-end processes through bleeding-edge e-tailers.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Support</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading mb-5 text-center">
                            ...
                            <p class="lead">Distinctively productize team driven niches with 24/7 outsourcing. Conveniently enable functional ROI with compelling imperatives.</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-around">
                                ...
                                <li class="d-flex align-items-center border rounded py-4 px-4">
                                    ...
                                    <div class="help-center-info">
                                        ...
                                        <p class="mb-0">Rapidiously reconceptualize technically sound sources with
                                            professional. </p>
                                        <a class="help-center-box-link" href="#"><i class="ti-angle-right p-3 rounded-circle primary-bg text-white"></i></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center border rounded py-4 px-4">
                                    <div class="icon-wrap mr-4">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="contact-us-content">
                            ...
                            <a href="#" class="btn outline-btn align-items-center">Chat With Us <span class="ti-arrow-right pl-2"></span></a>
...
<!-- Mirrored from HostMaji.themetags.com/support.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:13:00 GMT -->
</html>