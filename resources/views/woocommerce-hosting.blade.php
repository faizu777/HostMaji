...
<!-- Mirrored from HostMaji.themetags.com/woocommerce-hosting.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:54 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>WooCommerce Hosting - Hosting Provider with WHMCS Template</title>
...
<!--header section end-->
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="hero-equal-height ptb-100 gradient-overly-right" style="background: url('assets/img/hero-bg5.jpg')no-repeat center center / cover">
            <div class="container">
