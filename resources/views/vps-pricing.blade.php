...
<!-- Mirrored from HostMaji.themetags.com/vps-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:16 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>VPS Pricing - Hosting Provider with WHMCS Template</title>
    ...
    <div class="main">
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">VPS Pricing</h1>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">VPS Pricing</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <section class="vps-pricing-plane ptb-100">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="offer-block gradient-bg d-flex align-items-center justify-content-between px-5 py-4 position-relative z-index">
                            <div class="offer-content text-white">
                                <h5 class="mb-1 text-white">Our Server is 25% Faster</h5>
                                <p>With under 60 seconds worldwide deploy!</p>
                            </div>
                            <div class="offer-btn text-white">
                                <a href="#" class="btn solid-white-btn offer-link">Get Offer</a>
                            </div>
                        </div>
                        <table class="table vps-hosting-pricing-table vps-hosting-pricing-table-two">
                            ...
                            <tbody>
                                <tr class="vps-pricing-row border-accent-primary">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            <span class="rate">$3.95<span>/mo</span></span>
                                            <span class="pricing-onsale">On sale - <span class="badge color-3 color-3-bg">Save 30%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                ...
                                <tr class="vps-pricing-row border-red-themes">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            <span class="rate">$8.95<span>/mo</span></span>
                                            <span class="pricing-onsale">On sale - <span class="badge color-1 color-1-bg">Save 50%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                ...
                                <tr class="vps-pricing-row border-orange-themes">
                                    ...
                                    <td data-value="Price">
                                        <p>
                                            <span class="rate">$12.95<span>/mo</span></span>
                                            <span class="pricing-onsale">On sale - <span class="badge color-3 color-3-bg">Save 10%</span></span>
                                        </p>
                                    </td>
                                    <td>
                                ...
                                <tr class="vps-pricing-row border-yellow-themes">
                                    ...
                                    <td data-value="Bandwidth">4000GB</td>
                                    <td data-value="Price">
                                        <p><span class="rate">$15.95<span>/mo</span></span><span class="pricing-onsale">On sale - <span
                                            class="badge color-3 color-3-bg">Save 30%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="#" class="btn primary-solid-btn">Order Now</a>
                                ...
                                <tr class="vps-pricing-row border-blue-themes">
                                    ...
                                    <td data-value="Bandwidth">6000GB</td>
                                    <td data-value="Price">
                                        <p><span class="rate">$23.95<span>/mo</span></span><span class="pricing-onsale">On sale - <span
                                            class="badge color-5 color-5-bg">Save 40%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="#" class="btn primary-solid-btn">Order Now</a>
                                ...
                                <tr class="vps-pricing-row border-lime-themes">
                                    ...
                                    <td data-value="Bandwidth">8000GB</td>
                                    <td data-value="Price">
                                        <p><span class="rate">$29.95<span>/mo</span></span><span class="pricing-onsale">On sale - <span
                                            class="badge color-3 color-3-bg">Save 10%</span></span></p>
                                    </td>
                                    <td>
                                        <a href="#" class="btn primary-solid-btn">Order Now</a>
