...
<!-- Mirrored from HostMaji.themetags.com/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:51 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Coming Soon - Hosting Provider with WHMCS Template</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-12">
                        <div class="hero-content-wrap text-white text-center pt-5 pt-sm-5 pt-lg-0 pt-md-0">
                            ...
                            <div class="clock menu-countdown my-5"></div>
                            <form action="#" class="domain-search-form mt-5 w-75 m-auto">
                                <div class="input-group">
                                    <input type="email" class="form-control" id="email" placeholder="info@yourdomain.com" required="">
                                    <div class="input-group-append">
                                        <button class="btn search-btn btn-hover d-flex align-items-center" type="submit"> Subscribe
                                        </button>
                                    </div>
                                </div>
                            </form>
