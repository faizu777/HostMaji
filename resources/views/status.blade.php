...
<!-- Mirrored from HostMaji.themetags.com/status.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:50 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Status - Hosting Provider with WHMCS Template</title>
...
<body>
 ...
 <!--menu title with subtitle and icon item end-->
    ...
    <div class="main">
        ...
        <section class="page-header-section ptb-100 gradient-overly-right" style="background: url('assets/img/hero-bg-4.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Status</h1>
                            <p class="lead">Credibly transform low-risk high-yield strategic theme areas through market positioning interfaces. Rapidiously synthesize cutting-edge bandwidth.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            <h2>Our Services Status</h2>
                            <p class="lead">Dynamically create extensible convergence after resource maximizing
                                potentialities. Enthusiastically restore cutting-edge scenarios vis-a-vis.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="single-activaties-status gray-light-bg p-5 rounded text-center">
                            <h3 class="display-5 mb-0 font-weight-bold">0</h3>
                            <strong>Active Incidents</strong>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        <div class="single-activaties-status gray-light-bg p-5 rounded text-center">
                            <h3 class="display-5 mb-0 font-weight-bold">2</h3>
                            <strong>Maintenance Running</strong>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        <div class="single-activaties-status gray-light-bg p-5 rounded text-center">
                            <h3 class="display-5 mb-0 font-weight-bold">50</h3>
                            <strong>Solved Incidents</strong>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="services-status-wrap">
                            <ul class="list-unstyled services-status-list">
                                <li class="d-flex align-items-center white-bg p-4 rounded single-status">
                                    <div class="status-location-heading">
                                        <h5 class="mb-2">Hosted Status Pages <span class="ti-info-alt" data-toggle="tooltip"
                                                                                   data-placement="top"
                                                                                   title="Seamlessly monetize cooperative"></span>
                                        </h5>
                                        <span class="badge color-3 color-3-bg">Canada</span>
                                        <span class="badge color-3 color-3-bg">Brazil</span>
                                        <span class="badge color-3 color-3-bg">Finland</span>
                                        <span class="badge color-3 color-3-bg">India</span>
                                        <span class="badge color-3 color-3-bg">China</span>
                                    </div>
                                    <div class="status-mode">
                                        <span class="color-5 color-5-bg px-2 py-1 rounded"><strong>Operational</strong></span>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center white-bg p-4 rounded single-status">
                                    <div class="status-location-heading">
                                        <h5 class="mb-2">Status Notifications</h5>
                                        <span class="badge color-3 color-3-bg">Canada</span>
                                        <span class="badge color-3 color-3-bg">Brazil</span>
                                        <span class="badge color-3 color-3-bg">Finland</span>
                                        <span class="badge color-3 color-3-bg">India</span>
                                    ...
                                    <div class="status-mode">
                                        <span class="color-1 color-1-bg px-2 py-1 rounded"><strong>Operational</strong></span>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center white-bg p-4 rounded single-status">
                                    <div class="status-location-heading">
                                        <h5 class="mb-2">API Developed <span class="ti-info-alt" data-toggle="tooltip"
                                                                             data-placement="top"
                                                                             title="Seamlessly monetize cooperative"></span>
                                        </h5>
                                        <span class="badge color-3 color-3-bg">Canada</span>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <ul class="timeline-list mt-5 pl-3">
                            <li class="timeline-item">
                                ...
                                <span class="timeline-heading">March 9, 2019</span>
                                <h4 class="h5 text-danger">Forms, Meetings and Ads cannot be modified</h4>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Resolved</span> - The Front app is
                                        now loading properly for all users. We've identified and addressed the cause of the
                                        issue as a problem with the Forms, Meetings and Ads tools, and the incident has now
                                        been fully resolved.</p>
                                    <small class="d-block text-muted">Mar 8, 10:10 EST</small>
                                </div>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Investigating</span> - We're
                                        currently experiencing an issue that's preventing Forms, Meetings and Ads from being
                                        modified. All existing forms on websites continue working and accepting submissions.
                                        We're actively investigating the cause of this issue and will update this page when
                            ...
                            <li class="timeline-item">
                                ...
                                <span class="timeline-heading">March 8, 2019</span>
                                <h4 class="h5 text-warning">Chatflows cannot be modified</h4>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Resolved</span> - Chatflows is now
                                        operating properly for all users. We've identified and addressed the cause of the
                                        issue and the incident has now been fully resolved.</p>
                                    <small class="d-block text-muted">Mar 7, 12:24 EST</small>
                                </div>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Investigating</span> - Chatflows is
                                        now operating properly for all users. We've identified and addressed the cause of
                                        the issue and the incident has now been fully resolved.</p>
                                    <small class="d-block text-muted">Mar 7, 12:01 EST</small>
                                </div>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Monitoring</span> - We've identified
                                        the issue that's been preventing Chatflows from being modified. We're actively
                                        addressing the cause of this issue and will update this page when more information
                                        is available.</p>
                                    <small class="d-block text-muted">Mar 7, 11:24 EST</small>
                                </div>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Investigating</span> - We're
                                        currently experiencing an issue that's preventing Chatflow settings from being
                                        modified. We're actively investigating the cause of this issue and will update this
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Resolved</span> - Some customers may
                                        have experienced delayed Infrastructure alerts. We encourage customers to check the
                                        status of their applications and infrastructure during this time frame. Services
                                        have returned to their normal operation.</p>
                                    <small class="d-block text-muted">Mar 8, 19:51 EST</small>
                                </div>
                                <div class="mb-4">
                                    <p class="mb-2"><span class="font-weight-semi-bold">Investigating</span> - Some
                                        customers may be experiencing an issue with delayed Infrastructure Alerts. Please
