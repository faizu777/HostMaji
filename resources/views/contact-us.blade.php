...
<!-- Mirrored from HostMaji.themetags.com/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:13:00 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Contact Us - Hosting Provider with WHMCS Template</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            ...
                            <p class="lead">Have questions or need assistance? We're here to help! Reach out to us at HostMaji through the following channels:</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card single-promo-card single-promo-hover text-center">
                            <div class="card-body py-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">+91 9795405324</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card single-promo-card single-promo-hover text-center">
                            <div class="card-body py-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0"> hello@hostmaji.in</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-6">
                        <div class="contact-us-form gray-light-bg rounded p-5">
                            ...
                            <form action="#" method="POST" id="contactForm" class="contact-us-form mt-3" novalidate="novalidate">
                    ...
                    <div class="col-md-5">
                        <div class="contact-us-content">
                            ...
                            <br>
                            <span>Phone: +91 9795405324</span> <br>
                            <span>Email: <a href="mailto:hello@hostmaji.in" class="link-color">hello@hostmaji.in</a></span>
