...
<!-- Mirrored from HostMaji.themetags.com/pricing-new.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:16 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Pricing New - Hosting Provider with WHMCS Template</title>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Pricing Default</h1>
                            <p class="lead">Progressively revolutionize optimal methodologies for enterprise-wide technologies. Front-end catalysts for change rather than installed base ideas. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Pricing Default</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card single-pricing-pack text-center">
                            <div class="pt-5 px-4">
                                <h5 class="mb-0">Cloud Starter</h5>
                                <p>Medium traffic personal sites</p>
                            </div>
                            <div class="card-header py-4 border-0 pricing-header">
                                <div class="price mb-0">$19<span>/month</span></div>
                            </div>
                            <div class="card-body text-left px-5">
                                <ul class="list-unstyled mb-4 pricing-feature-list">
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>10</span> Hosted Domains</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>25 GB</span> RAID 10 Storage</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>200 GB</span> Bandwidth</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>1 Free</span> Domain included</li>
                                    <li class="del"><i class="ti-close color-6 pr-3"></i><span>Super Fast</span> SSD Storage</li>
                                ...
                                <a href="#" class="btn outline-btn mb-3 btn-block" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card popular-price single-pricing-pack text-center">
                            <div class="pt-5 px-4">
                                <h5 class="mb-0">Cloud Business <span class="badge color-1 color-1-bg">Popular</span></h5>
                                <p>High traffic corporate sites</p>
                            </div>
                            <div class="card-header py-4 border-0 pricing-header">
                                <div class="price mb-0">$49<span>/month</span></div>
                            </div>
                            <div class="card-body text-left px-5">
                                <ul class="list-unstyled mb-4 pricing-feature-list">
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>30</span> Hosted Domains</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>75 GB</span> RAID 10 Storage</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>700 GB</span> Bandwidth</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>3 Free</span> Domain included</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>Super Fast</span> SSD Storage</li>
                                    <li class="del"><i class="ti-close color-6 pr-3"></i><span>Free</span> SSL Certificate</li>
                                    <li class="del"><i class="ti-close color-6 pr-3"></i>99.95% Uptime</li>
                                    <li class="del"><i class="ti-close color-6 pr-3"></i>24/7 Phone Support</li>
                                </ul>
                                <a href="#" class="btn primary-solid-btn mb-3 btn-block" target="_blank">Purchase now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card single-pricing-pack text-center">
                            ...
                            <div class="card-header py-4 border-0 pricing-header">
                                <div class="price mb-0">$69<span>/month</span></div>
                            </div>
                            <div class="card-body text-left px-5">
                                <ul class="list-unstyled mb-4 pricing-feature-list">
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>60</span> Hosted Domains</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>175 GB</span> RAID 10 Storage</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>1500 GB</span> Bandwidth</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>6 Free</span> Domain included</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>Super Fast</span> SSD Storage</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i><span>Free</span> SSL Certificate</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i>99.95% Uptime</li>
                                    <li><i class="ti-check-box color-5 pr-3"></i>24/7 Phone Support</li>
                                </ul>
                                <a href="#" class="btn outline-btn mb-3 btn-block" target="_blank">Purchase now</a>
                            </div>
                        </div>
