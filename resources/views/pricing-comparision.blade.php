...
<!-- Mirrored from HostMaji.themetags.com/pricing-comparision.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Apr 2024 05:12:16 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Pricing Comparison - Hosting Provider with WHMCS Template</title>
...
<!--header section end-->
    ...
    <div class="main">
                ...
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-6">
                        <div class="page-header-content text-white">
                            <h1 class="text-white mb-2">Pricing Comparision</h1>
                            <p class="lead">Compellingly matrix cross-platform "outside the box" thinking after equity
                                invested testing procedures. Optimize scalable quality vectors with highly efficient.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb d-inline-block bg-transparent list-inline py-0 pl-0">
                                ...
                                <li class="list-inline-item breadcrumb-item active">Pricing Comparision</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                <thead class="comparision-table-head">
                                    <tr class="active">
                                        ...
                                        <th><strong class="h5 mb-0">Cloud Starter</strong>
                                            <p class="text-muted text-sm">For Small Business</p>
                                        </th>
                                        <th><strong class="h5 mb-0">Cloud Business <span
                                            class="badge color-1 color-1-bg">Popular</span></strong>
                                            <p class="text-muted text-sm">For Medium Business</p>
                                        </th>
                                        <th><strong class="h5 mb-0">Cloud Enterprise</strong>
                                ...
                                <tbody class="comparision-table-body">
                                    <tr>
                                        ...
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$4.5 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$10.99 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$15.99 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-left">Number of Websites</p>
                                        </td>
                                        <td>1</td>
                                        <td>5</td>
                                        <td>Unlimited</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">Email Accounts</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">Subdomains</p>
                                        </td>
                                        <td>5</td>
                                        <td>10</td>
                                        <td>Unlimited</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">FTP/SFTP/Shell Users</p>
                                        </td>
                                        <td>5</td>
                                        <td>10</td>
                                        <td>Unlimited</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">MySQL Databases</p>
                                        </td>
                                        <td>6</td>
                                        <td>15</td>
                                        <td>Unlimited</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">SSD Storage</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">Automated Daily Backups</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">24/7 Ticket Support</p>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">Live Chat Support</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left">Money-back Guarantee</p>
                                        </td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
        ...
        <!--compare pricing table start-->
        <section class="compare-pricing-section ptb-100 gray-light-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-heading text-center mb-5">
                            ...
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                <thead class="comparision-table-head">
                                    <tr class="active">
                                        ...
                                        <th><strong class="h5 mb-0">Basic Plan</strong>
                                            <p class="text-muted text-sm">For Small Business</p>
                                        </th>
                                        <th><strong class="h5 mb-0">Baby Plan<span
                                            class="badge color-1 color-1-bg">Popular</span></strong>
                                            <p class="text-muted text-sm">For Medium Business</p>
                                        </th>
                                        <th><strong class="h5 mb-0">Business Plan</strong>
                                            <p class="text-muted text-sm">For Large Business</p>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="comparision-table-body">
                                    <tr>
                                        ...
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$2.75 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$3.95 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$5.95 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Disk Space</p>
                                        </td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Bandwidth</p>
                                        </td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Domains Allowed</p>
                                        </td>
                                        <td>1 Domain</td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Free SSL </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Free Dedicated IP</p>
                                        </td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Free Positive SSL Upgrade </p>
                                        </td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                            ...
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    <tr>
                                        ...
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$2.5 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$3.99 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                                            <h4 class="mb-0 comparision-price">$5.99 <span>/month</span></h4>
                                            <a href="#" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">24/7/365 Support</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Instant Backups </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">No Contract</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">99.9% Uptime guarantee </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Google Adwords </p>
                                        </td>
                                        <td>$50 Credit</td>
                                        <td>$75 Credit</td>
                                        <td>$100 Credit</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Bing</p>
                                        </td>
                                        <td>$50 Credit</td>
                                        <td>$75 Credit</td>
                                        <td>$100 Credit</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Free/Instant Setup</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                        ...
                        <div class="table-responsive">
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Subdomains</p>
                                        </td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">FTP Accounts</p>
                                        </td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Addon/Parked Domains</p>
                                        </td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td>Unmetered</td>
                                        <td>Unmetered</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Anonymous FTP </p>
                                        </td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-close text-danger"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                        ...
                        <div class="table-responsive">
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">POP3 Accounts</p>
                                        </td>
                                        <td>Unlimited</td>
                                        <td>Unlimited</td>
                                        <td>Unlimited</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Web Mail</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Email Alias </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Auto Responders </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Mailing Lists </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Spam Assassin</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Mail Forwarding </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">SMTP</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                        ...
                        <div class="table-responsive">
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">AWStats (Real Time Updates)</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Webalizer</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Raw Logs</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Referrer Logs </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Error Logs </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                        ...
                        <div class="table-responsive">
                            <table class="table w-100 table-hover table-bordered comparision-table text-center">
                                ...
                                <tbody class="comparision-table-body">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">osCommerce</p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">ZenCart </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Private SSL Allowed </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="text-left font-weight-bold">Dedicated IP </p>
                                        </td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
                                        <td><span class="ti-check color-primary"></span></td>
